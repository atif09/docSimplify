      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <button
            ...
            className="p-1.5 rounded border border-slate-700 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white cursor-pointer transition"
        ...
        <div className="flex lg:hidden items-center gap-1.5">
          ...
          <button
            ...
            onClick={() => setHighContrast(!highContrast)}
            className="p-1.5 bg-slate-800 rounded border border-slate-700 cursor-pointer"
          >
            {highContrast ? <Sun size={15} /> : <Moon size={15} />}
          </button>
